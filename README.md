...
This repo exists to help new developers set up a local development instance of the BC Data Catalogue. The BC Data Catalogue is composed of a stock install of CKAN 2.7.5, along with custom extensions and several connected apps (e.g. a Vue-based UI frontend).
